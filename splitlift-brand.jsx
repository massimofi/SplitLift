...
function DumbbellGlyph({ size = 22, stroke = 'currentColor', strokeWidth = 2.2 }) {
...
function BrandLockup({ markSize = 56, showTagline = false }) {
  return (
...
Object.assign(window, { DumbbellGlyph, BrandMark, BrandLockup });
